...
public abstract class ParentActivity extends Activity implements View.OnClickListener{
	...
	public void onClick(View v) {
		...
		case R.id.imageButton1:
			triggerBookActivity(v);
			break;
		case R.id.imageButton7:
			triggerBookActivity2(v);
			break;
		case R.id.button1:
			triggerYourProfile(v);
			break;
		}
		
	}

	protected abstract void triggerYourProfile(View v); 
	...
	protected abstract void triggerBookActivity(View v);
	protected abstract void triggerBookActivity2(View v);
